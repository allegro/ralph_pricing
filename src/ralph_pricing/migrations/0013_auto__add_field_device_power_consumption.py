...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.power_consumption'
        db.add_column('ralph_pricing_device', 'power_consumption',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.power_consumption'
        db.delete_column('ralph_pricing_device', 'power_consumption')
