...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DailyStatistics'
        db.create_table('ralph_pricing_dailystatistics', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_pricing.UsageType'])),
            ('count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('ralph_pricing', ['DailyStatistics'])


    def backwards(self, orm):
        # Deleting model 'DailyStatistics'
        db.delete_table('ralph_pricing_dailystatistics')
    ...
    models = {
        ...
        'ralph_pricing.dailystatistics': {
            'Meta': {'object_name': 'DailyStatistics'},
