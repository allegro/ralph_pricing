...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.billing_type'
        db.add_column('ralph_pricing_team', 'billing_type',
                      self.gf('django.db.models.fields.CharField')(default=u'TIME', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.billing_type'
        db.delete_column('ralph_pricing_team', 'billing_type')
