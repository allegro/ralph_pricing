...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailyDevice.deprecation_rate'
        db.alter_column('ralph_pricing_dailydevice', 'deprecation_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=6))

    def backwards(self, orm):

        # Changing field 'DailyDevice.deprecation_rate'
        db.alter_column('ralph_pricing_dailydevice', 'deprecation_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=6))

    models = {
        'ralph_pricing.dailydevice': {
            'Meta': {'unique_together': "((u'date', u'pricing_device'),)", 'object_name': 'DailyDevice'},
            'date': ('django.db.models.fields.DateField', [], {}),
            'deprecation_rate': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '16', 'decimal_places': '6'}),
