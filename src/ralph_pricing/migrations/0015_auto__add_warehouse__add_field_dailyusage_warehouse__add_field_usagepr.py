...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Device.warehouse'
        db.add_column('ralph_pricing_device', 'warehouse',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_pricing.Warehouse'], null=True, on_delete=models.PROTECT),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Device.warehouse'
        db.delete_column('ralph_pricing_device', 'warehouse_id')
