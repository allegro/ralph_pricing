...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UsagePrice.expected_price'
        db.add_column('ralph_pricing_usageprice', 'expected_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=16, decimal_places=6),
                      keep_default=False)

        # Adding field 'UsagePrice.expected_cost'
        db.add_column('ralph_pricing_usageprice', 'expected_cost',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=16, decimal_places=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UsagePrice.expected_price'
        db.delete_column('ralph_pricing_usageprice', 'expected_price')

        # Deleting field 'UsagePrice.expected_cost'
        db.delete_column('ralph_pricing_usageprice', 'expected_cost')
    ...
    models = {
        ...
        'ralph_pricing.device': {
            ...
            'venture_symbol': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '32', 'blank': 'True'}),
            'warehouse': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ralph_pricing.Warehouse']", 'null': 'True', 'on_delete': 'models.PROTECT'})
        },
        ...
        'ralph_pricing.usageprice': {
            ...
            'end': ('django.db.models.fields.DateField', [], {}),
            'expected_cost': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '16', 'decimal_places': '6'}),
            'expected_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '16', 'decimal_places': '6'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '16', 'decimal_places': '6'}),
            'start': ('django.db.models.fields.DateField', [], {}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ralph_pricing.UsageType']"}),
