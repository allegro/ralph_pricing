...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.venture_symbol'
        db.add_column('ralph_pricing_device', 'venture_symbol',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.venture_symbol'
        db.delete_column('ralph_pricing_device', 'venture_symbol')
