...
from ralph_pricing.plugins.reports.power_consumption import (
    power_consumption_schema,
    power_consumption_usages,
)
...
class TestPowerConsumptionPlugin(TestCase):
    ...
    def test_schema(self):
        result = power_consumption_schema()
