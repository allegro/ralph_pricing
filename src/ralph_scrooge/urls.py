...
urlpatterns = patterns(
    ...
    url(
        ...
        ServicesCostsReportView.as_view(),
        name='services_costs_report',
    ),
    url(
        r'^services-usages-report/$',
        ServicesUsagesReportView.as_view(),
        name='services_usages_report',
    ),
    url(
        r'^services-changes-report/$',
        ServicesChangesReportView.as_view(),
        name='services_changes_report',
    ),
    url(
        r'^monthly-costs/$',
        MonthlyCosts.as_view(),
        name='monthly_costs',
    ),
    # costs forms
    url(
