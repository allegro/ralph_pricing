    ...
    def get_data(
        ...
        **kwargs
        ...
        query = """
            ...
            FROM ralph_scrooge_dailydevice AS dd1
                JOIN ralph_scrooge_dailydevice AS dd2
                JOIN ralph_scrooge_venture AS v1
                JOIN ralph_scrooge_venture AS v2
                JOIN ralph_scrooge_device AS dev
