...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'DailyPricingObject', fields ['date', 'pricing_object']
        db.create_unique(u'ralph_scrooge_dailypricingobject', ['date', 'pricing_object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DailyPricingObject', fields ['date', 'pricing_object']
        db.delete_unique(u'ralph_scrooge_dailypricingobject', ['date', 'pricing_object_id'])
