...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DailyUsage.environment'
        db.add_column(u'ralph_scrooge_dailyusage', 'environment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['ralph_scrooge.Environment']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DailyUsage.environment'
        db.delete_column(u'ralph_scrooge_dailyusage', 'environment_id')
    ...
    models = {
        ...
        u'ralph_scrooge.dailyusage': {
            ...
            'environment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ralph_scrooge.Environment']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            'service': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ralph_scrooge.Service']"}),
