...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ServiceOwnership.owner'
        db.delete_column(u'ralph_scrooge_serviceownership', 'owner_id')

        # Deleting field 'TeamManager.manager'
        db.delete_column(u'ralph_scrooge_teammanager', 'manager_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ServiceOwnership.owner'
        raise RuntimeError("Cannot reverse this migration. 'ServiceOwnership.owner' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ServiceOwnership.owner'
        db.add_column(u'ralph_scrooge_serviceownership', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_scrooge.Owner']),
                      keep_default=False)
        ...
        # User chose to not deal with backwards NULL issues for 'TeamManager.manager'
        raise RuntimeError("Cannot reverse this migration. 'TeamManager.manager' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'TeamManager.manager'
        db.add_column(u'ralph_scrooge_teammanager', 'manager',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_scrooge.Owner']),
                      keep_default=False)

        # Adding unique constraint on 'TeamManager', fields ['manager', 'team']
        db.create_unique(u'ralph_scrooge_teammanager', ['manager_id', 'team_id'])
    ...
    models = {
        ...
        u'ralph_scrooge.service': {
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['ralph_scrooge.ScroogeUser']", 'blank': 'True', 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'ownership': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'services'", 'symmetrical': 'False', 'through': u"orm['ralph_scrooge.ServiceOwnership']", 'to': u"orm['ralph_scrooge.ScroogeUser']"}),
        ...
        u'ralph_scrooge.serviceownership': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ralph_scrooge.ScroogeUser']", 'null': 'True', 'blank': 'True'}),
        ...
        u'ralph_scrooge.teammanager': {
            'Meta': {'object_name': 'TeamManager'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_manager': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ralph_scrooge.ScroogeUser']", 'null': 'True', 'blank': 'True'}),
            'team': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ralph_scrooge.Team']"})
        },
