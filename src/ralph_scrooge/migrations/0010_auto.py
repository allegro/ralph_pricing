...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'DailyCost', fields ['depth']
        db.create_index(u'ralph_scrooge_dailycost', ['depth'])

        # Adding index on 'DailyCost', fields ['date']
        db.create_index(u'ralph_scrooge_dailycost', ['date'])


    def backwards(self, orm):
        # Removing index on 'DailyCost', fields ['date']
        db.delete_index(u'ralph_scrooge_dailycost', ['date'])

        # Removing index on 'DailyCost', fields ['depth']
        db.delete_index(u'ralph_scrooge_dailycost', ['depth'])
