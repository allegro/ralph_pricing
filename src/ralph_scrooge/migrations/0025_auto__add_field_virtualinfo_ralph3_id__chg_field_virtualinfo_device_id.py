...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VirtualInfo.ralph3_id'
        db.add_column(u'ralph_scrooge_virtualinfo', 'ralph3_id',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'VirtualInfo.device_id'
        db.alter_column(u'ralph_scrooge_virtualinfo', 'device_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))

    def backwards(self, orm):
        # Deleting field 'VirtualInfo.ralph3_id'
        db.delete_column(u'ralph_scrooge_virtualinfo', 'ralph3_id')


        # User chose to not deal with backwards NULL issues for 'VirtualInfo.device_id'
        raise RuntimeError("Cannot reverse this migration. 'VirtualInfo.device_id' and its values cannot be restored.")
