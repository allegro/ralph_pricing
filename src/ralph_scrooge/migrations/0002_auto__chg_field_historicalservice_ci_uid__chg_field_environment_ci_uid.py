...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ProfitCenter', fields ['name']
        db.delete_unique(u'ralph_scrooge_profitcenter', ['name'])

        # Removing unique constraint on 'BusinessLine', fields ['name']
        db.delete_unique(u'ralph_scrooge_businessline', ['name'])

        # Removing unique constraint on 'Environment', fields ['name']
        db.delete_unique(u'ralph_scrooge_environment', ['name'])


        # Changing field 'HistoricalService.ci_uid'
        db.alter_column('ralph_scrooge_historicalservice', 'ci_uid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Environment.ci_uid'
        db.alter_column(u'ralph_scrooge_environment', 'ci_uid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        # Removing index on 'Environment', fields ['name']
        db.delete_index(u'ralph_scrooge_environment', ['name'])


        # Changing field 'Service.ci_uid'
        db.alter_column(u'ralph_scrooge_service', 'ci_uid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'BusinessLine.ci_uid'
        db.alter_column(u'ralph_scrooge_businessline', 'ci_uid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        # Removing index on 'BusinessLine', fields ['name']
        db.delete_index(u'ralph_scrooge_businessline', ['name'])


        # Changing field 'ProfitCenter.ci_uid'
        db.alter_column(u'ralph_scrooge_profitcenter', 'ci_uid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        # Removing index on 'ProfitCenter', fields ['name']
        db.delete_index(u'ralph_scrooge_profitcenter', ['name'])


    def backwards(self, orm):
        # Adding index on 'ProfitCenter', fields ['name']
        db.create_index(u'ralph_scrooge_profitcenter', ['name'])

        # Adding index on 'BusinessLine', fields ['name']
        db.create_index(u'ralph_scrooge_businessline', ['name'])

        # Adding index on 'Environment', fields ['name']
        db.create_index(u'ralph_scrooge_environment', ['name'])


        # Changing field 'HistoricalService.ci_uid'
        db.alter_column('ralph_scrooge_historicalservice', 'ci_uid', self.gf('django.db.models.fields.CharField')(default=0, max_length=100))

        # Changing field 'Environment.ci_uid'
        db.alter_column(u'ralph_scrooge_environment', 'ci_uid', self.gf('django.db.models.fields.CharField')(default=0, max_length=100))
        # Adding unique constraint on 'Environment', fields ['name']
        db.create_unique(u'ralph_scrooge_environment', ['name'])


        # Changing field 'Service.ci_uid'
        db.alter_column(u'ralph_scrooge_service', 'ci_uid', self.gf('django.db.models.fields.CharField')(default=0, max_length=100))

        # Changing field 'BusinessLine.ci_uid'
        db.alter_column(u'ralph_scrooge_businessline', 'ci_uid', self.gf('django.db.models.fields.CharField')(default=0, max_length=100))
        # Adding unique constraint on 'BusinessLine', fields ['name']
        db.create_unique(u'ralph_scrooge_businessline', ['name'])


        # Changing field 'ProfitCenter.ci_uid'
        db.alter_column(u'ralph_scrooge_profitcenter', 'ci_uid', self.gf('django.db.models.fields.CharField')(default=0, max_length=100))
        # Adding unique constraint on 'ProfitCenter', fields ['name']
        db.create_unique(u'ralph_scrooge_profitcenter', ['name'])
