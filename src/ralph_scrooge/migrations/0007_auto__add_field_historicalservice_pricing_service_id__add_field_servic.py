...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalService.pricing_service_id'
        db.add_column('ralph_scrooge_historicalservice', 'pricing_service_id',
        ...
        # Adding field 'Service.pricing_service'
        db.add_column(u'ralph_scrooge_service', 'pricing_service',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'services', null=True, to=orm['ralph_scrooge.PricingService']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalService.pricing_service_id'
        db.delete_column('ralph_scrooge_historicalservice', 'pricing_service_id')
        ...
        # Deleting field 'Service.pricing_service'
        db.delete_column(u'ralph_scrooge_service', 'pricing_service_id')
    ...
    models = {
        ...
        'ralph_scrooge.historicalservice': {
            ...
            'pricing_service_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'})
        },
