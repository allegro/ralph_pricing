...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TenantInfo.device_id'
        db.add_column(u'ralph_scrooge_tenantinfo', 'device_id',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TenantInfo.device_id'
        db.delete_column(u'ralph_scrooge_tenantinfo', 'device_id')
