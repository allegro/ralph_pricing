...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExtraCost.service_environment'
        db.add_column(u'ralph_scrooge_extracost', 'service_environment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name=u'extra_costs', to=orm['ralph_scrooge.ServiceEnvironment']),
                      keep_default=False)

        # Deleting field 'DailyExtraCost.service'
        db.delete_column(u'ralph_scrooge_dailyextracost', 'service_id')

        # Adding field 'DailyExtraCost.service_environment'
        db.add_column(u'ralph_scrooge_dailyextracost', 'service_environment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name=u'daily_extra_costs', to=orm['ralph_scrooge.ServiceEnvironment']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ExtraCost.service_environment'
        db.delete_column(u'ralph_scrooge_extracost', 'service_environment_id')
        ...
        # Deleting field 'DailyExtraCost.service_environment'
        db.delete_column(u'ralph_scrooge_dailyextracost', 'service_environment_id')
