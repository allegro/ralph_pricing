...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ralph_scrooge_service', 'business_line',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'services', null=True, to=orm['ralph_scrooge.BusinessLine']),
                      keep_default=False)

        # Adding field 'Service.ci_uid'
        db.add_column(u'ralph_scrooge_service', 'ci_uid',
                      self.gf('django.db.models.fields.CharField')(default=0, unique=True, max_length=100),
                      keep_default=False)
        ...
        # Adding field 'DailyExtraCost.service'
        db.add_column(u'ralph_scrooge_dailyextracost', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['ralph_scrooge.Service']),
                      keep_default=False)

        # Adding field 'DailyExtraCost.daily_pricing_object'
        db.add_column(u'ralph_scrooge_dailyextracost', 'daily_pricing_object',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ralph_scrooge.DailyPricingObject'], null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'ExtraCost.service'
        db.add_column(u'ralph_scrooge_extracost', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['ralph_scrooge.Service']),
                      keep_default=False)

        # Adding field 'ExtraCost.pricing_object'
        db.add_column(u'ralph_scrooge_extracost', 'pricing_object',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ralph_scrooge.PricingObject'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'ralph_scrooge_service', 'business_line_id')

        # Deleting field 'Service.ci_uid'
        db.delete_column(u'ralph_scrooge_service', 'ci_uid')
        ...
        # Deleting field 'DailyExtraCost.service'
        db.delete_column(u'ralph_scrooge_dailyextracost', 'service_id')

        # Deleting field 'DailyExtraCost.daily_pricing_object'
        db.delete_column(u'ralph_scrooge_dailyextracost', 'daily_pricing_object_id')
        ...
        # Deleting field 'ExtraCost.service'
        db.delete_column(u'ralph_scrooge_extracost', 'service_id')

        # Deleting field 'ExtraCost.pricing_object'
        db.delete_column(u'ralph_scrooge_extracost', 'pricing_object_id')
