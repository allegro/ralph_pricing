...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DailyVIPInfo'
        db.create_table(u'ralph_scrooge_dailyvipinfo', (
            ...
            ('vip_info', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'daily_vips', to=orm['ralph_scrooge.VIPInfo'])),
            ('ip_info', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'ip_daily_vips', to=orm['ralph_scrooge.PricingObject'])),
        ))
        db.send_create_signal(u'ralph_scrooge', ['DailyVIPInfo'])

        # Adding model 'VIPInfo'
        db.create_table(u'ralph_scrooge_vipinfo', (
            ...
            ('vip_id', self.gf('django.db.models.fields.IntegerField')(unique=True)),
            ('ip_info', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'vip', to=orm['ralph_scrooge.PricingObject'])),
            ('port', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('load_balancer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'vips', null=True, to=orm['ralph_scrooge.PricingObject'])),
        ))
        db.send_create_signal(u'ralph_scrooge', ['VIPInfo'])


    def backwards(self, orm):
        # Deleting model 'DailyVIPInfo'
        db.delete_table(u'ralph_scrooge_dailyvipinfo')

        # Deleting model 'VIPInfo'
        db.delete_table(u'ralph_scrooge_vipinfo')
