...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ServiceOwnership.new_owner'
        db.add_column(u'ralph_scrooge_serviceownership', 'new_owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_scrooge.ScroogeUser'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'TeamManager.new_manager'
        db.add_column(u'ralph_scrooge_teammanager', 'new_manager',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_scrooge.ScroogeUser'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Owner.profile'
        raise RuntimeError("Cannot reverse this migration. 'Owner.profile' and its values cannot be restored.")
        ...
        # Deleting field 'ServiceOwnership.new_owner'
        db.delete_column(u'ralph_scrooge_serviceownership', 'new_owner_id')

        # Deleting field 'TeamManager.new_manager'
        db.delete_column(u'ralph_scrooge_teammanager', 'new_manager_id')
    ...
    models = {
        ...
        u'ralph_scrooge.service': {
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['ralph_scrooge.ScroogeUser']", 'blank': 'True', 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'new_ownership': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'services'", 'symmetrical': 'False', 'through': u"orm['ralph_scrooge.ServiceOwnership']", 'to': u"orm['ralph_scrooge.ScroogeUser']"}),
