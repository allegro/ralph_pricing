...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseUsage.symbol'
        db.add_column(u'ralph_scrooge_baseusage', 'symbol',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'UsageType.symbol'
        db.delete_column(u'ralph_scrooge_usagetype', 'symbol')


    def backwards(self, orm):
        # Deleting field 'BaseUsage.symbol'
        db.delete_column(u'ralph_scrooge_baseusage', 'symbol')

        # Adding field 'UsageType.symbol'
        db.add_column(u'ralph_scrooge_usagetype', 'symbol',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)
