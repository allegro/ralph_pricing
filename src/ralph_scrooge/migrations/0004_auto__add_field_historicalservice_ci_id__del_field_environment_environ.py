...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'Environment.environment_id' and its values cannot be restored.")
        ...
        # User chose to not deal with backwards NULL issues for 'Environment.environment_id'
