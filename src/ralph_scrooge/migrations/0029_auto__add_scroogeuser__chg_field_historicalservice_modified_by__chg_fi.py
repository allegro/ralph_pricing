...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'ralph_scrooge', ['ScroogeUser'])

        # Adding M2M table for field groups on 'ScroogeUser'
        m2m_table_name = db.shorten_name(u'ralph_scrooge_scroogeuser_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scroogeuser', models.ForeignKey(orm[u'ralph_scrooge.scroogeuser'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['scroogeuser_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'ScroogeUser'
        m2m_table_name = db.shorten_name(u'ralph_scrooge_scroogeuser_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scroogeuser', models.ForeignKey(orm[u'ralph_scrooge.scroogeuser'], null=False)),
            ('permission', models.ForeignKey(orm[u'auth.permission'], null=False))
        ))
        db.create_unique(m2m_table_name, ['scroogeuser_id', 'permission_id'])


        # Changing field 'HistoricalService.modified_by'
        db.alter_column(u'ralph_scrooge_historicalservice', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['ralph_scrooge.ScroogeUser'], null=True))

        # Changing field 'HistoricalService.created_by'
        db.alter_column(u'ralph_scrooge_historicalservice', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['ralph_scrooge.ScroogeUser'], null=True))

        # Changing field 'HistoricalService.history_user'
        db.alter_column(u'ralph_scrooge_historicalservice', u'history_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['ralph_scrooge.ScroogeUser']))

        # Changing field 'UserProfile.user'
        db.alter_column(u'account_profile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ralph_scrooge.ScroogeUser'], unique=True))
        # Adding field 'Owner.user'
        db.add_column(u'ralph_scrooge_owner', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ralph_scrooge.ScroogeUser'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Changing field 'Owner.profile'
        db.alter_column(u'ralph_scrooge_owner', 'profile_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ralph_scrooge.UserProfile'], unique=True, null=True))

        # Changing field 'Warehouse.modified_by'
        db.alter_column(u'ralph_scrooge_warehouse', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['ralph_scrooge.ScroogeUser'], null=True))

        # Changing field 'Warehouse.created_by'
        db.alter_column(u'ralph_scrooge_warehouse', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['ralph_scrooge.ScroogeUser'], null=True))

        # Changing field 'Service.modified_by'
        db.alter_column(u'ralph_scrooge_service', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['ralph_scrooge.ScroogeUser'], null=True))

        # Changing field 'Service.created_by'
        db.alter_column(u'ralph_scrooge_service', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['ralph_scrooge.ScroogeUser'], null=True))

        # Changing field 'Team.modified_by'
        db.alter_column(u'ralph_scrooge_team', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['ralph_scrooge.ScroogeUser'], null=True))

        # Changing field 'Team.created_by'
        db.alter_column(u'ralph_scrooge_team', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['ralph_scrooge.ScroogeUser'], null=True))

        # Changing field 'PricingObject.modified_by'
        db.alter_column(u'ralph_scrooge_pricingobject', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['ralph_scrooge.ScroogeUser'], null=True))

        # Changing field 'PricingObject.created_by'
        db.alter_column(u'ralph_scrooge_pricingobject', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['ralph_scrooge.ScroogeUser'], null=True))

    def backwards(self, orm):
        # Deleting model 'ScroogeUser'
        db.delete_table(u'ralph_scrooge_scroogeuser')

        # Removing M2M table for field groups on 'ScroogeUser'
        db.delete_table(db.shorten_name(u'ralph_scrooge_scroogeuser_groups'))

        # Removing M2M table for field user_permissions on 'ScroogeUser'
        db.delete_table(db.shorten_name(u'ralph_scrooge_scroogeuser_user_permissions'))


        # Changing field 'HistoricalService.modified_by'
        db.alter_column(u'ralph_scrooge_historicalservice', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['ralph_scrooge.UserProfile'], null=True))

        # Changing field 'HistoricalService.created_by'
        db.alter_column(u'ralph_scrooge_historicalservice', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['ralph_scrooge.UserProfile'], null=True))

        # Changing field 'HistoricalService.history_user'
        db.alter_column(u'ralph_scrooge_historicalservice', u'history_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'UserProfile.user'
        db.alter_column(u'account_profile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Deleting field 'Owner.user'
        db.delete_column(u'ralph_scrooge_owner', 'user_id')
    ...
    models = {
        ...
        u'ralph_scrooge.assetinfo': {
            ...
            u'pricingobject_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['ralph_scrooge.PricingObject']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'ralph_scrooge.dailyassetinfo': {
            ...
            u'dailypricingobject_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['ralph_scrooge.DailyPricingObject']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'ralph_scrooge.dynamicextracosttype': {
            ...
            u'baseusage_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['ralph_scrooge.BaseUsage']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'ralph_scrooge.historicalservice': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['ralph_scrooge.ScroogeUser']", 'blank': 'True', 'null': 'True'}),
            u'history_date': ('django.db.models.fields.DateTimeField', [], {}),
            u'history_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            u'history_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            u'history_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['ralph_scrooge.ScroogeUser']"}),
            u'id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'blank': 'True'}),
            'manually_allocate_costs': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['ralph_scrooge.ScroogeUser']", 'blank': 'True', 'null': 'True'}),
        ...
        u'ralph_scrooge.owner': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['ralph_scrooge.UserProfile']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['ralph_scrooge.ScroogeUser']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'ralph_scrooge.scroogeuser': {
            'Meta': {'object_name': 'ScroogeUser'},
        ...
        u'ralph_scrooge.userprofile': {
            'Meta': {'object_name': 'UserProfile', 'db_table': "u'account_profile'"},
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['ralph_scrooge.ScroogeUser']", 'unique': 'True'})
        },
