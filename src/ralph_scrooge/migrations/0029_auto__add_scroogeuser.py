...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'scrooge_user', (
            ...
            ('employee_id', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ...
            ('department', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('manager', self.gf('django.db.models.fields.CharField')(max_length=1024, blank=True)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('segment', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
        ))
        db.send_create_signal(u'ralph_scrooge', ['ScroogeUser'])

        # Adding M2M table for field groups on 'ScroogeUser'
        m2m_table_name = db.shorten_name(u'scrooge_user_groups')
        ...
        m2m_table_name = db.shorten_name(u'scrooge_user_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scroogeuser', models.ForeignKey(orm[u'ralph_scrooge.scroogeuser'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'scrooge_user')

        # Removing M2M table for field groups on 'ScroogeUser'
        db.delete_table(db.shorten_name(u'scrooge_user_groups'))

        # Removing M2M table for field user_permissions on 'ScroogeUser'
        db.delete_table(db.shorten_name(u'scrooge_user_user_permissions'))
    ...
    models = {
        ...
        u'ralph_scrooge.historicalservice': {
            ...
            u'history_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
        ...
        u'ralph_scrooge.owner': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['ralph_scrooge.UserProfile']", 'unique': 'True'})
        },
        ...
        u'ralph_scrooge.scroogeuser': {
            'Meta': {'object_name': 'ScroogeUser', 'db_table': "u'scrooge_user'"},
