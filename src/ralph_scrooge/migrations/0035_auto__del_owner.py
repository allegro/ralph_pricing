...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'ralph_scrooge_owner', (
            ('profile', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ralph_scrooge.UserProfile'], unique=True, null=True, blank=True)),
            ('cache_version', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ralph_scrooge.ScroogeUser'], unique=True, null=True, blank=True)),
