...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('ralph_scrooge_serviceownership', 'new_owner_id', 'owner_id')
        db.rename_column('ralph_scrooge_teammanager', 'new_manager_id', 'manager_id')
    ...
    def backwards(self, orm):
        ...
        db.rename_column('ralph_scrooge_serviceownership', 'owner_id', 'new_owner_id')
        db.rename_column('ralph_scrooge_teammanager', 'manager_id', 'new_manager_id')
    ...
    models = {
        ...
        u'ralph_scrooge.serviceownership': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ralph_scrooge.ScroogeUser']"}),
        ...
        u'ralph_scrooge.teammanager': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manager': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ralph_scrooge.ScroogeUser']"}),
            'team': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ralph_scrooge.Team']"})
        },
