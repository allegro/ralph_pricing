...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseUsage.divide_by'
        db.add_column(u'ralph_scrooge_baseusage', 'divide_by',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BaseUsage.rounding'
        db.add_column(u'ralph_scrooge_baseusage', 'rounding',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'UsageType.rounding'
        db.delete_column(u'ralph_scrooge_usagetype', 'rounding')

        # Deleting field 'UsageType.divide_by'
        db.delete_column(u'ralph_scrooge_usagetype', 'divide_by')


    def backwards(self, orm):
        # Deleting field 'BaseUsage.divide_by'
        db.delete_column(u'ralph_scrooge_baseusage', 'divide_by')

        # Deleting field 'BaseUsage.rounding'
        db.delete_column(u'ralph_scrooge_baseusage', 'rounding')

        # Adding field 'UsageType.rounding'
        db.add_column(u'ralph_scrooge_usagetype', 'rounding',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UsageType.divide_by'
        db.add_column(u'ralph_scrooge_usagetype', 'divide_by',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
