...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Team.show_in_report'
        db.delete_column(u'ralph_scrooge_team', 'show_in_report')
        ...
        # Deleting field 'UsageType.show_in_devices_report'
        db.delete_column(u'ralph_scrooge_usagetype', 'show_in_devices_report')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Team.show_in_report'
        db.add_column(u'ralph_scrooge_team', 'show_in_report',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
        ...
        # Adding field 'UsageType.show_in_devices_report'
        db.add_column(u'ralph_scrooge_usagetype', 'show_in_devices_report',
