...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailyVirtualInfo.hypervisor'
        db.alter_column(u'ralph_scrooge_dailyvirtualinfo', 'hypervisor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ralph_scrooge.DailyAssetInfo']))

    def backwards(self, orm):

        # Changing field 'DailyVirtualInfo.hypervisor'
        db.alter_column(u'ralph_scrooge_dailyvirtualinfo', 'hypervisor_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['ralph_scrooge.DailyAssetInfo']))
