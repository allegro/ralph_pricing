...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalService.ralph3_id'
        db.add_column('ralph_scrooge_historicalservice', 'ralph3_id',
        ...
        db.alter_column('ralph_scrooge_historicalservice', u'history_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'HistoricalService.ci_id'
        db.alter_column('ralph_scrooge_historicalservice', 'ci_id', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Adding field 'AssetInfo.ralph3_asset_id'
        db.add_column(u'ralph_scrooge_assetinfo', 'ralph3_asset_id',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'AssetInfo.asset_id'
        db.alter_column(u'ralph_scrooge_assetinfo', 'asset_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))
        # Adding field 'Warehouse.ralph3_id'
        db.add_column(u'ralph_scrooge_warehouse', 'ralph3_id',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Warehouse.id_from_assets'
        db.alter_column(u'ralph_scrooge_warehouse', 'id_from_assets', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))
        # Adding field 'Environment.ralph3_id'
        db.add_column(u'ralph_scrooge_environment', 'ralph3_id',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Environment.ci_id'
        db.alter_column(u'ralph_scrooge_environment', 'ci_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))
        # Adding field 'PricingObjectModel.ralph3_model_id'
        db.add_column(u'ralph_scrooge_pricingobjectmodel', 'ralph3_model_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Service.ralph3_id'
        db.add_column(u'ralph_scrooge_service', 'ralph3_id',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Service.ci_id'
        db.alter_column(u'ralph_scrooge_service', 'ci_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))
        # Adding field 'TenantInfo.ralph3_tenant_id'
        db.add_column(u'ralph_scrooge_tenantinfo', 'ralph3_tenant_id',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, unique=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'TenantInfo.tenant_id'
        db.alter_column(u'ralph_scrooge_tenantinfo', 'tenant_id', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True))
        # Adding field 'BusinessLine.ralph3_id'
        db.add_column(u'ralph_scrooge_businessline', 'ralph3_id',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'BusinessLine.ci_id'
        db.alter_column(u'ralph_scrooge_businessline', 'ci_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))
        # Adding field 'ProfitCenter.ralph3_id'
        db.add_column(u'ralph_scrooge_profitcenter', 'ralph3_id',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'ProfitCenter.ci_id'
        db.alter_column(u'ralph_scrooge_profitcenter', 'ci_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))

    def backwards(self, orm):
        # Deleting field 'HistoricalService.ralph3_id'
        db.delete_column('ralph_scrooge_historicalservice', 'ralph3_id')
        ...
        # User chose to not deal with backwards NULL issues for 'HistoricalService.ci_id'
        raise RuntimeError("Cannot reverse this migration. 'HistoricalService.ci_id' and its values cannot be restored.")
        # Deleting field 'AssetInfo.ralph3_asset_id'
        db.delete_column(u'ralph_scrooge_assetinfo', 'ralph3_asset_id')


        # User chose to not deal with backwards NULL issues for 'AssetInfo.asset_id'
        raise RuntimeError("Cannot reverse this migration. 'AssetInfo.asset_id' and its values cannot be restored.")
        # Deleting field 'Warehouse.ralph3_id'
        db.delete_column(u'ralph_scrooge_warehouse', 'ralph3_id')


        # User chose to not deal with backwards NULL issues for 'Warehouse.id_from_assets'
        raise RuntimeError("Cannot reverse this migration. 'Warehouse.id_from_assets' and its values cannot be restored.")
        # Deleting field 'Environment.ralph3_id'
        db.delete_column(u'ralph_scrooge_environment', 'ralph3_id')


        # User chose to not deal with backwards NULL issues for 'Environment.ci_id'
        raise RuntimeError("Cannot reverse this migration. 'Environment.ci_id' and its values cannot be restored.")
        # Deleting field 'PricingObjectModel.ralph3_model_id'
        db.delete_column(u'ralph_scrooge_pricingobjectmodel', 'ralph3_model_id')

        # Deleting field 'Service.ralph3_id'
        db.delete_column(u'ralph_scrooge_service', 'ralph3_id')


        # User chose to not deal with backwards NULL issues for 'Service.ci_id'
        raise RuntimeError("Cannot reverse this migration. 'Service.ci_id' and its values cannot be restored.")
        # Deleting field 'TenantInfo.ralph3_tenant_id'
        db.delete_column(u'ralph_scrooge_tenantinfo', 'ralph3_tenant_id')


        # User chose to not deal with backwards NULL issues for 'TenantInfo.tenant_id'
        raise RuntimeError("Cannot reverse this migration. 'TenantInfo.tenant_id' and its values cannot be restored.")
        # Deleting field 'BusinessLine.ralph3_id'
        db.delete_column(u'ralph_scrooge_businessline', 'ralph3_id')


        # User chose to not deal with backwards NULL issues for 'BusinessLine.ci_id'
        raise RuntimeError("Cannot reverse this migration. 'BusinessLine.ci_id' and its values cannot be restored.")
        # Deleting field 'ProfitCenter.ralph3_id'
        db.delete_column(u'ralph_scrooge_profitcenter', 'ralph3_id')


        # User chose to not deal with backwards NULL issues for 'ProfitCenter.ci_id'
        raise RuntimeError("Cannot reverse this migration. 'ProfitCenter.ci_id' and its values cannot be restored.")
