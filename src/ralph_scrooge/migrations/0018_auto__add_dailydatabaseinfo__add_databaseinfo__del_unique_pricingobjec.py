...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PricingObjectModel', fields ['model_id']
        db.delete_unique(u'ralph_scrooge_pricingobjectmodel', ['model_id'])

        # Adding model 'DailyDatabaseInfo'
        db.create_table(u'ralph_scrooge_dailydatabaseinfo', (
            ...
            ('parent_device', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'daily_databases', null=True, to=orm['ralph_scrooge.DailyAssetInfo'])),
            ('database_info', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'daily_databases', to=orm['ralph_scrooge.DatabaseInfo'])),
        ))
        db.send_create_signal(u'ralph_scrooge', ['DailyDatabaseInfo'])

        # Adding model 'DatabaseInfo'
        db.create_table(u'ralph_scrooge_databaseinfo', (
            ...
            ('database_id', self.gf('django.db.models.fields.IntegerField')(unique=True)),
            ('parent_device', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'databases', null=True, to=orm['ralph_scrooge.AssetInfo'])),
        ))
        db.send_create_signal(u'ralph_scrooge', ['DatabaseInfo'])

        # Adding unique constraint on 'PricingObjectModel', fields ['model_id', 'type']
        db.create_unique(u'ralph_scrooge_pricingobjectmodel', ['model_id', 'type_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PricingObjectModel', fields ['model_id', 'type']
        db.delete_unique(u'ralph_scrooge_pricingobjectmodel', ['model_id', 'type_id'])

        # Deleting model 'DailyDatabaseInfo'
        db.delete_table(u'ralph_scrooge_dailydatabaseinfo')

        # Deleting model 'DatabaseInfo'
        db.delete_table(u'ralph_scrooge_databaseinfo')

        # Adding unique constraint on 'PricingObjectModel', fields ['model_id']
        db.create_unique(u'ralph_scrooge_pricingobjectmodel', ['model_id'])
