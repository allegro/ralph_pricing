...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'ralph_scrooge_usageprice', ['internet_provider_id', 'type_id', 'end'])
        ...
        db.delete_column(u'ralph_scrooge_usageprice', 'internet_provider_id')

        # Deleting field 'UsageType.by_internet_provider'
        db.delete_column(u'ralph_scrooge_usagetype', 'by_internet_provider')

        # Deleting field 'UsageType.show_price_percentage'
        db.delete_column(u'ralph_scrooge_usagetype', 'show_price_percentage')


        # Changing field 'DailyUsage.date'
        db.alter_column(u'ralph_scrooge_dailyusage', 'date', self.gf('django.db.models.fields.DateField')())
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'ralph_scrooge_usageprice', 'internet_provider',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_scrooge.InternetProvider'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)
        ...
        db.create_unique(u'ralph_scrooge_usageprice', ['internet_provider_id', 'type_id', 'end'])

        # Adding field 'UsageType.by_internet_provider'
        db.add_column(u'ralph_scrooge_usagetype', 'by_internet_provider',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UsageType.show_price_percentage'
        db.add_column(u'ralph_scrooge_usagetype', 'show_price_percentage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'DailyUsage.date'
        db.alter_column(u'ralph_scrooge_dailyusage', 'date', self.gf('django.db.models.fields.DateTimeField')())
