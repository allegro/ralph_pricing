...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ralph_scrooge_dynamicextracostdivision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dynamic_extra_cost_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'dynamic_division', to=orm['ralph_scrooge.DynamicExtraCostType'])),
    ...
    models = {
        ...
        u'ralph_scrooge.dynamicextracostdivision': {
            ...
            'dynamic_extra_cost_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'dynamic_division'", 'to': u"orm['ralph_scrooge.DynamicExtraCostType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
