...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UsageType.show_in_ventures_report'
        db.delete_column(u'ralph_scrooge_usagetype', 'show_in_ventures_report')

        # Adding field 'UsageType.show_in_services_report'
        db.add_column(u'ralph_scrooge_usagetype', 'show_in_services_report',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'DailyVirtualInfo.virtual_info'
        db.add_column(u'ralph_scrooge_dailyvirtualinfo', 'virtual_info',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['ralph_scrooge.VirtualInfo']),
                      keep_default=False)


        # Changing field 'DailyUsage.warehouse'
        db.alter_column(u'ralph_scrooge_dailyusage', 'warehouse_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_scrooge.Warehouse'], on_delete=models.PROTECT))
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UsageType.show_in_ventures_report'
        db.add_column(u'ralph_scrooge_usagetype', 'show_in_ventures_report',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'UsageType.show_in_services_report'
        db.delete_column(u'ralph_scrooge_usagetype', 'show_in_services_report')

        # Deleting field 'DailyVirtualInfo.virtual_info'
        db.delete_column(u'ralph_scrooge_dailyvirtualinfo', 'virtual_info_id')


        # Changing field 'DailyUsage.warehouse'
        db.alter_column(u'ralph_scrooge_dailyusage', 'warehouse_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_scrooge.Warehouse'], null=True, on_delete=models.PROTECT))
