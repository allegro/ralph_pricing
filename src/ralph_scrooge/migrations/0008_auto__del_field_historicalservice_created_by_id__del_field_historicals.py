...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HistoricalService.created_by_id'
        db.delete_column('ralph_scrooge_historicalservice', 'created_by_id')

        # Deleting field 'HistoricalService.business_line_id'
        db.delete_column('ralph_scrooge_historicalservice', 'business_line_id')

        # Deleting field 'HistoricalService.modified_by_id'
        db.delete_column('ralph_scrooge_historicalservice', 'modified_by_id')

        # Adding field 'HistoricalService.created_by'
        db.add_column('ralph_scrooge_historicalservice', 'created_by',
        ...
        # Adding field 'HistoricalService.modified_by'
        db.add_column('ralph_scrooge_historicalservice', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'+', on_delete=models.SET_NULL, default=None, to=orm['account.Profile'], blank=True, null=True),
                      keep_default=False)

        # Adding field 'HistoricalService.business_line'
        db.add_column('ralph_scrooge_historicalservice', 'business_line',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'+', to=orm['ralph_scrooge.BusinessLine']),
                      keep_default=False)


        # Changing field 'Service.business_line'
        db.alter_column(u'ralph_scrooge_service', 'business_line_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_scrooge.BusinessLine']))

    def backwards(self, orm):
        # Adding field 'HistoricalService.created_by_id'
        db.add_column('ralph_scrooge_historicalservice', 'created_by_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True, db_index=True),
                      keep_default=False)

        # Adding field 'HistoricalService.business_line_id'
        db.add_column('ralph_scrooge_historicalservice', 'business_line_id',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'HistoricalService.modified_by_id'
        db.add_column('ralph_scrooge_historicalservice', 'modified_by_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True, db_index=True),
                      keep_default=False)

        # Deleting field 'HistoricalService.created_by'
        db.delete_column('ralph_scrooge_historicalservice', 'created_by_id')

        # Deleting field 'HistoricalService.modified_by'
        db.delete_column('ralph_scrooge_historicalservice', 'modified_by_id')

        # Deleting field 'HistoricalService.business_line'
        db.delete_column('ralph_scrooge_historicalservice', 'business_line_id')


        # Changing field 'Service.business_line'
        db.alter_column(u'ralph_scrooge_service', 'business_line_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ralph_scrooge.BusinessLine']))
    ...
    models = {
        ...
        'ralph_scrooge.historicalservice': {
            ...
            'business_line': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'to': u"orm['ralph_scrooge.BusinessLine']"}),
