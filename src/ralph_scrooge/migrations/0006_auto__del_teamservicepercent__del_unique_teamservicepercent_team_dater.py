...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'ralph_scrooge_usageprice', ['type_id', 'end', 'team_id'])

        # Removing unique constraint on 'UsagePrice', fields ['start', 'type', 'team']
        db.delete_unique(u'ralph_scrooge_usageprice', ['start', 'type_id', 'team_id'])
        ...
        db.delete_column(u'ralph_scrooge_usageprice', 'team_members_count')

        # Deleting field 'UsagePrice.team'
        db.delete_column(u'ralph_scrooge_usageprice', 'team_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'ralph_scrooge_usageprice', 'team_members_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UsagePrice.team'
        db.add_column(u'ralph_scrooge_usageprice', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_scrooge.Team'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'UsagePrice', fields ['start', 'type', 'team']
        db.create_unique(u'ralph_scrooge_usageprice', ['start', 'type_id', 'team_id'])

        # Adding unique constraint on 'UsagePrice', fields ['type', 'end', 'team']
        db.create_unique(u'ralph_scrooge_usageprice', ['type_id', 'end', 'team_id'])


        # Changing field 'Team.billing_type'
        db.alter_column(u'ralph_scrooge_team', 'billing_type', self.gf('django.db.models.fields.CharField')(max_length=15))
        # Adding field 'UsageType.by_team'
        db.add_column(u'ralph_scrooge_usagetype', 'by_team',
