# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2018-03-26 11:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('back_office_asset_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='daily_back_office_asset_info_set', to='ralph_scrooge.BackOfficeAssetInfo', verbose_name='daily asset details')),
            ],
            options={
