...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'ralph_scrooge_usageprice', ['warehouse_id', 'type_id', 'end'])
        ...
        # Changing field 'Owner.first_name'
        db.alter_column(u'ralph_scrooge_owner', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=5))
        # Adding unique constraint on 'TenantInfo', fields ['tenant_id']
        db.create_unique(u'ralph_scrooge_tenantinfo', ['tenant_id'])

        # Adding unique constraint on 'ServiceUsageTypes', fields ['start', 'usage_type', 'end', 'pricing_service']
        db.create_unique(u'ralph_scrooge_serviceusagetypes', ['start', 'usage_type_id', 'end', 'pricing_service_id'])

        # Adding unique constraint on 'ServiceEnvironment', fields ['environment', 'service']
        db.create_unique(u'ralph_scrooge_serviceenvironment', ['environment_id', 'service_id'])

        # Adding unique constraint on 'ServiceOwnership', fields ['owner', 'type', 'service']
        db.create_unique(u'ralph_scrooge_serviceownership', ['owner_id', 'type', 'service_id'])

        # Adding unique constraint on 'PricingObject', fields ['type', 'service_environment', 'name']
        db.create_unique(u'ralph_scrooge_pricingobject', ['type', 'service_environment_id', 'name'])

        # Adding unique constraint on 'UsageType', fields ['symbol']
        db.create_unique(u'ralph_scrooge_usagetype', ['symbol'])

        # Adding unique constraint on 'DailyPricingObject', fields ['date', 'service_environment', 'pricing_object']
        db.create_unique(u'ralph_scrooge_dailypricingobject', ['date', 'service_environment_id', 'pricing_object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DailyPricingObject', fields ['date', 'service_environment', 'pricing_object']
        db.delete_unique(u'ralph_scrooge_dailypricingobject', ['date', 'service_environment_id', 'pricing_object_id'])

        # Removing unique constraint on 'UsageType', fields ['symbol']
        db.delete_unique(u'ralph_scrooge_usagetype', ['symbol'])

        # Removing unique constraint on 'PricingObject', fields ['type', 'service_environment', 'name']
        db.delete_unique(u'ralph_scrooge_pricingobject', ['type', 'service_environment_id', 'name'])

        # Removing unique constraint on 'ServiceOwnership', fields ['owner', 'type', 'service']
        db.delete_unique(u'ralph_scrooge_serviceownership', ['owner_id', 'type', 'service_id'])

        # Removing unique constraint on 'ServiceEnvironment', fields ['environment', 'service']
        db.delete_unique(u'ralph_scrooge_serviceenvironment', ['environment_id', 'service_id'])

        # Removing unique constraint on 'ServiceUsageTypes', fields ['start', 'usage_type', 'end', 'pricing_service']
        db.delete_unique(u'ralph_scrooge_serviceusagetypes', ['start', 'usage_type_id', 'end', 'pricing_service_id'])

        # Removing unique constraint on 'TenantInfo', fields ['tenant_id']
        db.delete_unique(u'ralph_scrooge_tenantinfo', ['tenant_id'])


        # Changing field 'Owner.first_name'
        db.alter_column(u'ralph_scrooge_owner', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=50))
        ...
        db.create_unique(u'ralph_scrooge_usageprice', ['warehouse_id', 'type_id', 'end'])
    ...
    models = {
        ...
        u'ralph_scrooge.dailypricingobject': {
            'Meta': {'unique_together': "((u'service_environment', u'pricing_object', u'date'),)", 'object_name': 'DailyPricingObject'},
            'date': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
