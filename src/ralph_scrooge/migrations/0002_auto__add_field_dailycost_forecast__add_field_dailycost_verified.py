...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DailyCost.forecast'
        db.add_column(u'ralph_scrooge_dailycost', 'forecast',
    ...
    def backwards(self, orm):
        # Deleting field 'DailyCost.forecast'
        db.delete_column(u'ralph_scrooge_dailycost', 'forecast')
