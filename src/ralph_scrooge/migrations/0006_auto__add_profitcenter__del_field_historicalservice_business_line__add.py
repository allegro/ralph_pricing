...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HistoricalService.profit_center'
        db.add_column('ralph_scrooge_historicalservice', 'profit_center',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name=u'+', to=orm['ralph_scrooge.ProfitCenter']),
                      keep_default=False)

        # Deleting field 'Service.business_line'
        db.delete_column(u'ralph_scrooge_service', 'business_line_id')

        # Adding field 'Service.profit_center'
        db.add_column(u'ralph_scrooge_service', 'profit_center',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name=u'services', to=orm['ralph_scrooge.ProfitCenter']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('ralph_scrooge_historicalservice', 'business_line',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name=u'+', to=orm['ralph_scrooge.BusinessLine']),
                      keep_default=False)

        # Deleting field 'HistoricalService.profit_center'
        db.delete_column('ralph_scrooge_historicalservice', 'profit_center_id')

        # Adding field 'Service.business_line'
        db.add_column(u'ralph_scrooge_service', 'business_line',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name=u'services', to=orm['ralph_scrooge.BusinessLine']),
                      keep_default=False)

        # Deleting field 'Service.profit_center'
        db.delete_column(u'ralph_scrooge_service', 'profit_center_id')
