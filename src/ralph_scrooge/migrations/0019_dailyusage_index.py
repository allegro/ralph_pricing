...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'DailyUsage', fields ['type', 'date', 'warehouse']
        db.create_index(u'ralph_scrooge_dailyusage', ['type_id', 'date', 'warehouse_id'])

        db.create_index(u'ralph_scrooge_dailypricingobject', ['date', 'service_environment_id'])

    def backwards(self, orm):
        # Removing index on 'DailyUsage', fields ['type', 'date', 'warehouse']
        db.delete_index(u'ralph_scrooge_dailyusage', ['type_id', 'date', 'warehouse_id'])

        db.delete_index(u'ralph_scrooge_dailypricingobject', ['date', 'service_environment_id'])
