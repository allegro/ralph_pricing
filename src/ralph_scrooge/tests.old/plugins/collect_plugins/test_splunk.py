...
from ralph_scrooge.models import DailyDevice, Device, DailyUsage, Venture
from ralph_scrooge.plugins.collects.splunk import (
    splunk as splunk_runner,
)
from ralph_scrooge.tests.plugins.collect_plugins.samples.splunk import (
    hosts_usages_data
)
...
class TestSplunkPluginTest(TestCase):
    ...
    SPLUNK_PLUGIN_PATH = 'ralph_scrooge.plugins.collects.splunk.Splunk'
