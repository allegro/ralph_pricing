...
from ralph_scrooge.models import DailyUsage, Venture
from ralph_scrooge.plugins.collects.openstack import (
    openstack as openstack_runner,
)
from ralph_scrooge.tests.plugins.collect_plugins.samples.openstack import (
...
class TestOpenstack(TestCase):
    ...
    def test_set_usages(self):
        ...
        with mock.patch(
            'ralph_scrooge.plugins.collects.openstack.OpenStack'
        ) as OpenStack:
