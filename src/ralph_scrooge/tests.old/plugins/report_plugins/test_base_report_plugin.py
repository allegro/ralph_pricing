...
class TestBaseReportPlugin(TestCase):
    ...
    # _distribute_costs
    # =========================================================================
    @mock.patch('ralph_scrooge.plugins.reports.service.BaseReportPlugin._get_usages_in_period_per_venture')  # noqa
    @mock.patch('ralph_scrooge.plugins.reports.service.BaseReportPlugin._get_total_usage_in_period')  # noqa
