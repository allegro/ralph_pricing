...
class TestTeamPlugin(TestCase):
    ...
    @mock.patch('ralph_scrooge.plugins.reports.team.Team._get_cores_count_by_venture')  # noqa
    @mock.patch('ralph_scrooge.plugins.reports.team.Team._get_total_devices_count')  # noqa
    @mock.patch('ralph_scrooge.plugins.reports.team.Team._get_devices_count_by_venture')  # noqa
    ...
    @mock.patch('ralph_scrooge.plugins.reports.team.Team._get_team_time_cost_per_venture')  # noqa
    @mock.patch('ralph_scrooge.plugins.reports.team.Team._get_team_devices_cores_cost_per_venture')  # noqa
    @mock.patch('ralph_scrooge.plugins.reports.team.Team._get_team_devices_cost_per_venture')  # noqa
    @mock.patch('ralph_scrooge.plugins.reports.team.Team._get_team_distributed_cost_per_venture')  # noqa
