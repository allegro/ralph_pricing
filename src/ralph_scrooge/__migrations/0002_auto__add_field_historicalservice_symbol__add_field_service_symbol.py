...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalService.symbol'
        db.add_column('ralph_scrooge_historicalservice', 'symbol',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Service.symbol'
        db.add_column(u'ralph_scrooge_service', 'symbol',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalService.symbol'
        db.delete_column('ralph_scrooge_historicalservice', 'symbol')

        # Deleting field 'Service.symbol'
        db.delete_column(u'ralph_scrooge_service', 'symbol')
