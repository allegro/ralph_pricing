...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PricingObjectType'
        db.create_table(u'ralph_scrooge_pricingobjecttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('color', self.gf('django.db.models.fields.CharField')(default=u'#428bca', max_length=30, null=True, blank=True)),
        ))
        db.send_create_signal(u'ralph_scrooge', ['PricingObjectType'])

        # Adding model 'PricingObjectModel'
        db.create_table(u'ralph_scrooge_pricingobjectmodel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(default=255, related_name=u'pricing_object_models', to=orm['ralph_scrooge.PricingObjectType'])),
        ))
        db.send_create_signal(u'ralph_scrooge', ['PricingObjectModel'])

        # Adding model 'TeamManager'
        db.create_table(u'ralph_scrooge_teammanager', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_scrooge.Team'])),
            ('manager', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_scrooge.Owner'])),
        ))
        db.send_create_signal(u'ralph_scrooge', ['TeamManager'])
        ...
        db.rename_column(u'ralph_scrooge_assetinfo', 'model_id', 'model_old_id')

        # Deleting field 'PricingObject.color'
        db.delete_column(u'ralph_scrooge_pricingobject', 'color')

        # Adding field 'PricingObject.model'
        db.add_column(u'ralph_scrooge_pricingobject', 'model',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'pricing_objects', null=True, to=orm['ralph_scrooge.PricingObjectModel']),
                      keep_default=False)

        # Renaming column for 'PricingObject.type' to match new field type.
        db.rename_column(u'ralph_scrooge_pricingobject', 'type', 'type_id')
        # Changing field 'PricingObject.type'
        db.alter_column(u'ralph_scrooge_pricingobject', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_scrooge.PricingObjectType']))
        # Adding index on 'PricingObject', fields ['type']
        try:
            db.create_index(u'ralph_scrooge_pricingobject', ['type_id'])
    ...
    models = {
        ...
        u'ralph_scrooge.assetinfo': {
            ...
            'model_old': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ralph_scrooge.AssetModel']"}),
        ...
        u'ralph_scrooge.pricingobjecttype': {
            ...
            'color': ('django.db.models.fields.CharField', [], {'default': "u'#428bca'", 'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
