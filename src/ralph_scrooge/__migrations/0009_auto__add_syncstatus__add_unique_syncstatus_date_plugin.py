...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SyncStatus'
        db.create_table(u'ralph_scrooge_syncstatus', (
        ...
        db.send_create_signal(u'ralph_scrooge', ['SyncStatus'])

        # Adding unique constraint on 'SyncStatus', fields ['date', 'plugin']
        db.create_unique(u'ralph_scrooge_syncstatus', ['date', 'plugin'])


    def backwards(self, orm):
        # Removing unique constraint on 'SyncStatus', fields ['date', 'plugin']
        db.delete_unique(u'ralph_scrooge_syncstatus', ['date', 'plugin'])

        # Deleting model 'SyncStatus'
        db.delete_table(u'ralph_scrooge_syncstatus')
