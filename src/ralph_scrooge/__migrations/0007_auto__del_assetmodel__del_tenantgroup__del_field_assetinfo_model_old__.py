...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AssetInfo.model_old'
        db.delete_column(u'ralph_scrooge_assetinfo', 'model_old_id')

        # Adding unique constraint on 'PricingObjectType', fields ['color']
        db.create_unique(u'ralph_scrooge_pricingobjecttype', ['color'])

        # Adding unique constraint on 'PricingObjectType', fields ['name']
        db.create_unique(u'ralph_scrooge_pricingobjecttype', ['name'])

        # Deleting field 'TenantInfo.group'
        db.delete_column(u'ralph_scrooge_tenantinfo', 'group_id')


    def backwards(self, orm):
        # Removing unique constraint on 'PricingObjectType', fields ['name']
        db.delete_unique(u'ralph_scrooge_pricingobjecttype', ['name'])

        # Removing unique constraint on 'PricingObjectType', fields ['color']
        db.delete_unique(u'ralph_scrooge_pricingobjecttype', ['color'])
        ...
        # Adding field 'AssetInfo.model_old'
        db.add_column(u'ralph_scrooge_assetinfo', 'model_old',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['ralph_scrooge.AssetModel']),
                      keep_default=False)

        # Adding field 'TenantInfo.group'
        db.add_column(u'ralph_scrooge_tenantinfo', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name=u'tenants', to=orm['ralph_scrooge.TenantGroup']),
                      keep_default=False)
