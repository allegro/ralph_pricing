...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalService.manually_allocate_costs'
        db.add_column('ralph_scrooge_historicalservice', 'manually_allocate_costs',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Service.manually_allocate_costs'
        db.add_column(u'ralph_scrooge_service', 'manually_allocate_costs',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalService.manually_allocate_costs'
        db.delete_column('ralph_scrooge_historicalservice', 'manually_allocate_costs')

        # Deleting field 'Service.manually_allocate_costs'
        db.delete_column(u'ralph_scrooge_service', 'manually_allocate_costs')
    ...
    models = {
        ...
        u'ralph_scrooge.pricingobject': {
            ...
            'cache_version': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'color': ('django.db.models.fields.PositiveIntegerField', [], {'default': '255'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': "orm['account.Profile']", 'blank': 'True', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
