...
from ralph_scrooge.models import DailyUsage, UsageType, Venture
from ralph_scrooge.plugins.collects.scaleme import (
...
class TestScaleme(TestCase):
    ...
    def test_set_usages(self):
        ...
        with mock.patch(
            'ralph_scrooge.plugins.collects.scaleme.get_ventures_capacities'
