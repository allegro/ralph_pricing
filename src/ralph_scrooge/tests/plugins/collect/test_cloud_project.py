...
from ralph_scrooge.plugins.collect.cloud_project import (
...
TEST_SETTINGS_UNKNOWN_SERVICES_ENVIRONMENTS = dict(
    UNKNOWN_SERVICES_ENVIRONMENTS={'tenant': UNKNOWN_SERVICE_ENVIRONMENT},
)
...
class TestServiceCollectPlugin(TestCase):
    ...
    def _get_sample_tenant(self):
        return {
            ...
            'service_env': {
                ...
                'service_uid': self.service_environment.service.symbol,
            },
            'name': 'sample_tenant',
            'remarks': 'qwerty',
        }
    ...
    def test_save_tenant_info(self):
        ...
        sample_tenant['service_env']['service_uid'] = (
            self.service_environment.service.symbol
        )
    ...
    @mock.patch('ralph_scrooge.plugins.collect.cloud_project.get_cloud_provider_id')  # noqa
    @mock.patch('ralph_scrooge.plugins.collect.cloud_project.get_from_ralph')
    @mock.patch('ralph_scrooge.plugins.collect.cloud_project.update_tenant')
    @override_settings(**TEST_SETTINGS_UNKNOWN_SERVICES_ENVIRONMENTS)
    ...
    @mock.patch('ralph_scrooge.plugins.collect.cloud_project.get_unknown_service_env')  # noqa
    @override_settings(**TEST_SETTINGS_UNKNOWN_SERVICES_ENVIRONMENTS)
