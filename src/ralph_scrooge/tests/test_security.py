...
class TestSecurity(TestCase):
    def setUp(self):
        ...
        scrooge_owner = OwnerFactory(profile=self.owner)
        ...
        team_manager = OwnerFactory(profile=self.team_manager)
    ...
    def _get_report(self):
        return self.client.get('/services-costs-report/')
