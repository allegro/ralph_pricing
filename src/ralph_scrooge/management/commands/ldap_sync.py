# -*- coding: utf-8 -*-
# source code from:
# https://raw.githubusercontent.com/allegro/ralph/develop/src/ralph/account/management/commands/ldap_sync.py  # noqa
...
from ralph_scrooge.utils.ldap import get_ldap
